  ...
  return (
    <div className="max-w-xl p-6">
      <div className="flex items-center gap-3 mb-1">
        ...
        <h1 className="text-2xl font-bold text-gray-900">היומן שלי ב-Google</h1>
      </div>
      <p className="text-sm text-gray-500 mb-8">
        חבר את יומן Google האישי שלך כדי שהמערכת תזהה חפיפות כשמקבעים שיעורים עם המורה שלך.
      </p>
    ...
    <div className="space-y-4">
      ...
      <div>
        <p className="text-xs text-gray-500 mb-2">
          ניתוק יגרום לביטול בדיקת החפיפות מול היומן האישי שלך.
        </p>
