          ...
          <SubSection title="4.7 Cookies וטכנולוגיות מעקב">
            ...
            <Ul
              items={[
                ...
                'Microsoft Clarity — מיפוי חוויית משתמש בדפי האתר השיווקיים (heatmaps, הקלטות סשן). נטען רק לאחר הסכמה ל-cookies אנליטיים.',
                'מדידה עצמית אנונימית של Lessio — בדפי האתר השיווקיים אנו סופרים ביקורים בעצמנו, ללא צד שלישי: מאיזה קישור הגיע הביקור, אילו חלקים בדף נצפו, כמה זמן נמשך ועל אילו כפתורים לחצו. המדידה נשענת על מזהה אקראי שנשמר ב-cookie, אינה שומרת כתובת IP, שם, טלפון או כתובת מלאה של האתר המפנה, ונמחקת לאחר 180 יום.',
        ...
        <Section title="7. מסירת מידע לצדדים שלישיים">
          ...
          <Ul
            items={[
              ...
              'שירותי Google (אופציונלי) — כאשר הלקוח העסקי מחבר את חשבון Google שלו, הודעות דוא"ל עשויות להישלח דרך Gmail תחת חשבונו, ונתוני זמינות (פנוי/עסוק) עשויים להיקרא מ-Google Calendar שלו. לא נכתב דבר ליומן.',
          ...
          <SubSection title="7.1 אינטגרציות שהלקוח העסקי מחבר">
            <p>
              ...
              או הנמען ותוכן ההודעה במייל). הספק מעבד את המידע בהתאם לתנאי השימוש ומדיניות הפרטיות שלו, והלקוח
        ...
        <Section title="14. Cookies וטכנולוגיות מעקב">
          ...
          <Ul
            items={[
              ...
              'Cookie מדידה אנונימי — מזהה מבקר אקראי של Lessio עצמה, המשמש לספירת ביקורים בדפי האתר השיווקיים ולשיוך הרשמה למקור שממנו הגיעה. אינו מזהה אדם, אינו משותף עם צד שלישי ופועל ללא תלות בבחירה בבאנר.',
              'Cookies אנליטיים — Google Analytics 4 לניתוח שימוש ושיפור המוצר; Microsoft Clarity למיפוי חוויית משתמש. נטענים רק לאחר הסכמה.',
              'Cookies שיווקיים — Meta Pixel למעקב המרות מפרסום. נטענים רק לאחר הסכמה.',
              'Cookies לניטור שגיאות — Sentry לאיתור ותיעוד תקלות טכניות.',
            ]}
          />
          <p>
            את ה-cookies האנליטיים והשיווקיים של צדדים שלישיים בוחרים בבאנר שמוצג בביקור הראשון
            באתר: אפשר לדחות את כולם, לאשר אנליטיים בלבד, או לאשר הכול, והם אינם נטענים לפני
            הבחירה. כדי לשנות בחירה קודמת יש למחוק את ה-cookies של האתר בדפדפן, והבאנר יוצג שוב.
            שימוש באתר ובמערכת לאחר הרשמה מהווה הסכמה לשימוש ב-cookies חיוניים.
          </p>
        </Section>
