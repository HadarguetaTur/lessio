...
/**
 * A modal for a decision the user cannot undo by closing it — cancel a lesson,
 * delete an account. Unlike Dialog it has no dismiss button in the corner: the
 * choice has to be made through one of the two actions.
 *
 * Radix supplies the parts that a hand-rolled overlay always ends up missing:
 * the alertdialog role, a focus trap, Escape to dismiss, and a labelled title
 * and description wired to the content via aria.
 */
